...
<script type="text/javascript">
  $().ready(function() {
	  $("#deleteBtn").click(function(){
		  location.href = "<c:url value="/remove/y?token=${token}"/>"
	  });
	   	
	  $("#nDeleteBtn").click(function(){
		  location.href = "<c:url value="/remove/n?token=${token}"/>"
	  });
	  ...
	  $("#myCommunities").click(function(){
		  ...
		  window.open("<c:url value="/mypage/communities"/>", 
				  "나의 추억들",
				  "width=500, height=500, scrollbars=yes, resizeable=no");
	  });
   ...
   <div id="wrapper">
      ...
      <div class="box" >
		...
		<div style="text=align: center;">
			...
			<div id="canceleBtn" class="button">홈으로..</div>
		</div>
         </div>
      </div>
